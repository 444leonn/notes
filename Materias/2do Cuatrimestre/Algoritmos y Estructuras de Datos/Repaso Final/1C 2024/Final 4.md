...
Explique qué es el Teorema Maestro, sus condiciones de aplicación, para qué se utiliza y de un ejemplo de uso.  
...
![](../images/1C-2024-final-4.png)  



## Ejercicio 3

Explique qué es un árbol Rojo/Negro y enumere las propiedades que debe cumplir.  
...
Explique cómo funciona el algoritmo de Floyd-Warshall, qué condiciones debe cumplir el grafo para poder ser aplicado y qué información nos da.  
...
Dada una tabla de hash cerrada de capacidad inicial 4 y función de hashing F(k)=3k-1; dibuje el estado de la tabla luego de insertar(+) y eliminar(-) cada uno de los siguientes pares en el orden dado: +<A;3>, +<D;6>, +<G;9>, +<J;3>, +<M;1>, -<B>, -<G>, -<A>, +<D;1>.  
