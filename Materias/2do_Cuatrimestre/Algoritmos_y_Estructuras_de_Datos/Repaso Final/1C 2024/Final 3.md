...
El algoritmo Babilónico para el cálculo de la raíz cuadrada de x consiste en seleccionar una estimación inicial de la raíz a calcular (ej: e=x/2 ) y luego iterativamente verificar si la diferencia entre (e *x* e) y el numero original difieren a lo sumo un valor máximo PRECISION.  
...
Explique (con diagramas) cómo funciona heap-sort.  
...
Explique qué es un recorrido BFS. Suponga que tiene a disposición un TDA Grafo.  
...
Explique qué es una tabla de hash cerrada.  
